...
public class Inventory {
    ...
    // once this equals false, we will need to update the database and remove the
    // items used
    // to create the hamper from collected data, and update the new inventory to the
    // database
    ...
    public Inventory(int[] itemID, int[] grain, int[] fruitsVeggies, int[] protein, int[] otherContent,
            int[] calories) {
    ...
    public Inventory getInventory() {
        ...
        try {
            ...
            // int rowCount = myStmt.executeUpdate(); // after execture statement will show
            ...
            Inventory theInv = new Inventory(tempID, tempGrainContent, tempFVContent, tempProContent, tempOther,
                    tempCalories);
            return theInv;
