...
public class FinalProjectTest {
    ...
    public void testGetNumberOfChildrenUnderEight() {
        ...
        assertEquals("Method getChildrenUnderEight did not return the expected results:", numChildrenUnderEightExpected,
                numChildrenUnderEight);
    }
    ...
    public void testSetNumberOfChildrenUnderEight() {
        ...
        assertEquals("Method setChildrenUnderEight did not return the expected results:", numChildrenUnderEightExpected,
                numChildrenUnderEight);
    }
    ...
    public void testGetChilrenOverEight() {
        ...
        assertEquals("Method getChildrenOverEight did not return the expectes results:", numChildrenOverEightExpected,
                numChildrenOverEight);
    }
    ...
    public void testSetChildrenOverEight() {
        ...
        assertEquals("Method setChildrenOverEight did not return the expected results:", numChildrenOverEightExpected,
                numChildrenOverEight);
    }
    ...
    public void testIsIOExceptionThrown() {
        ...
        assertEquals("Order constructor did not throw an IllegalArugmentException when given invalid input: ", true,
                correctException);
    ...
    //testing if weekly service required
    @Test
    public void weeklyServicesWorks() {
        if (familyProfile.mobility == true) {
            ...
            assertEquals("The correct number of weekly hampers not made.", numberofFamilyHampersNeeded,
                    numberofHampers);
        }
